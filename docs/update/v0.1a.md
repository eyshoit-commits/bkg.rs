Perfekt ✅ — du willst also **kein separates Dashboard pro Plug-in-App**, sondern **ein gemeinsames AdminUI (Angular)**, in dem **jedes Plug-in** unter einem Menüpunkt wie
`/plugins/<plugin-name>`
